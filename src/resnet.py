...
if __name__ == '__main__':
    ...
    train_generator = train_datagen.flow_from_dataframe(train, directory='./data/images/',
                                                        target_size=(384, 384),
                                                        x_col="image_id",
    ...
    history_1 = model_finetuned.fit_generator(train_generator,
                                              ...
                                              , verbose=1, callbacks=[
            ReduceLROnPlateau(monitor='val_loss', factor=0.3, patience=3, min_lr=0.000001)], use_multiprocessing=False,
                                              shuffle=True)
